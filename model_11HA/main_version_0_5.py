...
with open('./../data/trainingsets_11HA/20000_train_regular_qm9/image_train.pickle', 'rb') as f:
    X_smiles_train, X_atoms_train, X_bonds_train, y_train = pickle.load(f)
    
with open('./../data/trainingsets_11HA/20000_train_regular_qm9/image_test.pickle', 'rb') as f:
...
encoder = load_model('./../data/nns_11HA/encoder.h5')
decoder = load_model('./../data/nns_11HA/decoder.h5')
...
#regressor = load_model    ('./../data/nns_11HA/regressor.h5')
#regressor_top = load_model('./../data/nns_11HA/regressor_top.h5')
...
regressor.save    ('./../data/nns_11HA/regressor.h5')
regressor_top.save('./../data/nns_11HA/regressor_top.h5')

#regressor = load_model    ('./../data/nns_11HA/regressor.h5')
#regressor_top = load_model('./../data/nns_11HA/regressor_top.h5')
#generator = load_model    ('./../data/nns_11HA/generator.h5')
#discriminator= load_model ('./../data/nns_11HA/discriminator.h5')
...
generator.save('./../data/nns_11HA/generator.h5')
discriminator.save('./../data/nns_11HA/discriminator.h5')
...
output.to_csv ('./../experiments/regular_11HA/Regular_13.csv', index = False)
output2.to_csv('./../experiments/regular_11HA/Regular_NODUP_13.csv', index = False)
