...
try:
    ...
    model = load_model  ('./../data/nns_11HA/ae_model.h5')
    print (".h5 files were read")
except:
    print ("no previous trained files")
    model.compile(optimizer = Adam(learning_rate = 9e-5),
              loss = ['binary_crossentropy', 'mse'])
    pass
...
model.save('./../data/nns_11HA/ae_model.h5')
encoder.save('./../data/nns_11HA/encoder.h5')
decoder.save('./../data/nns_11HA/decoder.h5')
