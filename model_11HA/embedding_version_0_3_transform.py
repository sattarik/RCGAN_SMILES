...
with open('image_train_highhc.pickle', 'rb') as f:
    X_smiles_train, X_atoms_train, X_bonds_train, y_train = pickle.load(f)

with open('image_test_highhc.pickle', 'rb') as f:
...
model.save('ae_model_transform.h5')
encoder.save('encoder_transform.h5')
decoder.save('decoder_transform.h5')
