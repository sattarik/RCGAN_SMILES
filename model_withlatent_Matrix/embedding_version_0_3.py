...
y1 = Conv2D(64, (1, 2), strides = 1, padding = 'valid')(inp_1)
y1 = LeakyReLU(alpha = 0.2)(y1)
y1 = BatchNormalization()(y1)

y1 = Conv2D(64, 2, strides = 1, padding = 'same')(y1)
y1 = LeakyReLU(alpha = 0.2)(y1)
y1 = BatchNormalization()(y1)
...
y2 = Conv2D(64, 1, strides = 1, padding = 'valid')(inp_2)
y2 = LeakyReLU(alpha = 0.2)(y2)
y2 = BatchNormalization()(y2)

y2 = Conv2D(64, 2, strides = 1, padding = 'same')(y2)
y2 = LeakyReLU(alpha = 0.2)(y2)
y2 = BatchNormalization()(y2)
...
emb_in1 = Reshape ((8, 8, 2))(emb_in)

tower0 = Conv2D(32, 1, padding = 'same')(emb_in1)
tower1 = Conv2D(64, 1, padding = 'same')(emb_in1)
tower1 = Conv2D(64, 3, padding = 'same')(tower1)
tower2 = Conv2D(32, 1, padding = 'same')(emb_in1)
tower2 = Conv2D(32, 5, padding = 'same')(tower2)
tower3 = MaxPooling2D(3, 1, padding = 'same')(emb_in1)
