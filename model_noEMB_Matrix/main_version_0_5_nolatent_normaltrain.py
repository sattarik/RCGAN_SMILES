...
encoder = load_model('./../data/nns/encoder_normal.h5')
decoder = load_model('./../data/nns/decoder_normal.h5')
...
regressor = load_model    ('./../data/nns/regressor_normal.h5')
regressor_top = load_model('./../data/nns/regressor_top_normal.h5')
...
regressor.save('./../data/nns/regressor_normal.h5')
regressor_top.save('./../data/nns/regressor_top_normal.h5')

regressor = load_model('./../data/nns/regressor_normal.h5')
regressor_top = load_model('./../data/nns/regressor_top_normal.h5')
#generator = load_model    ('./../data/nns/generator_normal.h5')
#discriminator= load_model ('./../data/nns/discriminator_normal.h5')
...
generator.save('./../data/nns/generator_normal.h5')
discriminator.save('./../data/nns/discriminator_normal.h5')
...
output.to_csv ('./../experiments/regular/Regular_100ep_normaltrain.csv', index = False)
output2.to_csv('./../experiments/regular/Regular_NODUP_100ep_normaltrain.csv', index = False)
