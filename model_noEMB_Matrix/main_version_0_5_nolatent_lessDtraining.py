...
for e in range(epochs):
    ...
    for b in range(batches):
		...
		# train discriminator 1, default = 3
        for _ in range(1):
...
generator.save('./../data/nns/generator2.h5')
discriminator.save('./../data/nns/discriminator2.h5')
...
generator = load_model    ('./../data/nns/generator2.h5')
discriminator = load_model('./../data/nns/discriminator2.h5')
...
output.to_csv ('./../experiments/regular/Regular_400ep_lesstrainD.csv', index = False)
output2.to_csv('./../experiments/regular/Regular_NODUP_400ep_lesstrainD.csv', index = False)
