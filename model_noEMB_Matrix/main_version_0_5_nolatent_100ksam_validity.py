...
output.to_csv ('./../experiments/regular/Regular_100ksam_validity.csv', index = False)
output2.to_csv('./../experiments/regular/Regular_NODUP_100ksam_validity.csv', index = False)
