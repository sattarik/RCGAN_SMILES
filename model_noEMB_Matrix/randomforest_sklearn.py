...
data_gen = pd.read_csv('Features_gen_smiles2.csv')
...
final_data_Feat_Cv_smiles = pd.read_csv('Features_gen_smiles2.csv')
final_data_Feat_Cv_smiles = final_data_Feat_Cv_smiles.iloc[acc_ids]
final_data_Feat_Cv_smiles.to_csv('final_data_Feat_Cv_smiles2.csv', index = False)
